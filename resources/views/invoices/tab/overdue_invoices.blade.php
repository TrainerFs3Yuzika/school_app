                ...
                <div class="row align-items-center">
                    <div class="col">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Faktur Terlambat</li>
                        </ul>
                    </div>
                    <div class="col-auto">
                            ...
                            <div class="col-lg-8 col-md-8">
                                <div class="invoices-tabs">
                                    <ul>
                                        ...
                                        <li><a class="active" href="{{ route('invoice/overdue/page') }}">Terlambat</a></li>
                                ...
                                <table class="table table-stripped table-hover datatable">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>16 Mar 2022</td>
                                            <td>23 Mar 2022</td>
                                            <td><span class="badge bg-danger-light">Terlambat 7 hari</span></td>
                                            <td class="text-end">
