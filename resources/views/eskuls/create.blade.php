                        ...
                        <div class="card-body">
                            <form action="{{ route('eskuls.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group local-forms">
                                            <label for="pembina" class="form-label">Nama Pembina <span class="login-danger">*</span></label>
                                            <input type="text" name="pembina" id="pembina" class="form-control"
                                                placeholder="Masukkan Nama Pembina" required>
                                        </div>
                                        <div class="form-group local-forms">
                                            <label for="waktu_eskul" class="form-label">Waktu Ekstrakurikulir <span class="login-danger">*</span></label>
                                            <input type="text" name="waktu_eskul" id="waktu_eskul" class="form-control"
                                                placeholder="Contoh: Senin, 14:00 - 16:00" required>
                                        </div>
                                    </div>
                                    <div class="mb-5">
                                        <label for="gambar" class="form-label">Gambar <span class="login-danger">*</span></label>
