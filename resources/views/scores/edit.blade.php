                    ...
                    <form action="{{ route('scores.update', $score->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select name="teacher_id" id="teacher_id" class="form-control">
                                @foreach ($teachers as $id => $name)
                                    <option value="{{ $id }}" @if ($score->teacher_id == $id) selected @endif>
                                        {{ $name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select name="student_id" id="student_id" class="form-control">
                                @foreach ($students as $id => $name)
                                    <option value="{{ $id }}" @if ($score->student_id == $id) selected @endif>
                                        {{ $name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select name="subject_id" id="subject_id" class="form-control">
                                @foreach ($subjects as $id => $name)
                                    <option value="{{ $id }}" @if ($score->subject_id == $id) selected @endif>
                                        {{ $name }}</option>
                                @endforeach
                            </select>
                        </div>
