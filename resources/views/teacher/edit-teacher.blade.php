                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <input type="text" class="form-control @error('full_name') is-invalid @enderror" name="full_name" placeholder="Masukkan Nama" value="{{ $teacher->full_name }}">
                                        @error('full_name')
                                ...
                                <div class="col-12 col-sm-4 local-forms">
                                    <div class="form-group local-forms calendar-icon">
                                        ...
                                        <input type="text" class="form-control datetimepicker @error('qualification') is-invalid @enderror" name="qualification" placeholder="Masukkan Kualifikasi" value="{{ $teacher->qualification }}">
                                        @error('qualification')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-6">
                                    <div class="form-group local-forms">
                                        ...
                                        <input type="text" class="form-control @error('address') is-invalid @enderror" name="address" placeholder="Masukkan Alamat" value="{{ $teacher->address }}">
                                        @error('address')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-6">
                                    <div class="form-group local-forms">
                                        ...
                                        <input type="text" class="form-control @error('phone_number') is-invalid @enderror" name="phone_number" placeholder="Masukkan Nomor Telepon" value="{{ $teacher->phone_number }}">
                                        @error('phone_number')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <input type="text" class="form-control @error('city') is-invalid @enderror" name="city" placeholder="Masukkan Kota" value="{{ $teacher->city }}">
                                        @error('city')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <input type="text" class="form-control @error('zip_code') is-invalid @enderror" name="zip_code" placeholder="Masukkan Kode Pos" value="{{ $teacher->zip_code }}">
                                        @error('zip_code')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <input type="text" class="form-control @error('country') is-invalid @enderror" name="country" placeholder="Masukkan Negara" value="{{ $teacher->country }}">
                                        @error('country')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
