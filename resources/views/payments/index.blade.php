                                                ...
                                                <td>
                                                    <div class="actions d-flex justify-content-start">
                                                        @if (auth()->user()->role_name === 'Admin')
                                                            ...
                                                            <!-- Tombol Export PDF -->
                                                            <a href="{{ route('payments.exportPDF', $payment->id) }}" class="btn btn-sm me-2">
...
<script>
    ...
    function submitPaymentForm() {
        ...
        // Perform AJAX submission using fetch or jQuery $.ajax
        ...
        .catch(error => {
            ...
            showAlertModal('Failed to submit payment. Please try again.');
        });
    }
