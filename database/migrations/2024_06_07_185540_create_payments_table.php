...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('payments', function (Blueprint $table) {
            ...
            $table->enum('payment_type', ['Biaya Pendidikan', 'Seragam Sekolah', 'Buku dan Materi Pelajaran', 'Kegiatan Ekstrakurikuler', 'Makanan dan Kantin', 'Transportasi', 'Biaya Acara dan Perjalanan', 'Biaya Teknologi', 'Biaya Tambahan', 'Donasi dan Sumbangan']);
